public class WindChillTemperature {
  public static void main(String[] args) {
    ...
    System.out.print("Enter the temperature in Fahenreit between -58\u00B0 F and 41\u00B0 F: ");
    ...
    double windChillTemperature =
        35.74
            + 0.6215 * temperatureOutside
            - 35.75 * Math.pow(windSpeed, 0.16)
            + 0.4275 * temperatureOutside * Math.pow(windSpeed, 0.16);

    // Display wind chill index surrounded by 6 digits
    System.out.println("Wind chill index is " + (int) (windChillTemperature * 1000000) / 1000000.0);
